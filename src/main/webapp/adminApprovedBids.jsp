...
<body class="bg">
	<div style="top: 0;">
		...
		<button class="tablink"
			...
			Crops</button>
		<button class="tablink"
			onclick="window.location.href = 'fetchAllFarmers.rsvp';">List Farmers</button>
		<button class="tablink"
			onclick="window.location.href = 'fetchAllBidders.rsvp';">List Bidders
			</button>
		<button class="tablink"
...
<div class="matebox"><form action="fetchAllBiddingBasedOnCropId.rsvp">
		<p>Enter CropId</p>
	...
	<h1 style="left: 10%; top:38%; position: absolute;margin-bottom:0;'">_List of Bids_</h1>
	...
	<h1 style="left: 62%; top:38%;margin-bottom:0;position: absolute;">_Bids based on Crops_</h1>
			...
			<c:forEach items="${ listOfBiddingBasedOnCropId }" var="bid">
				<tr>
					<form action="approveBid.rsvp">
						...
						<input type="hidden" name="cropId" value="${ bid.cropBid.cropId }"/>
