...
<%int i=1; %>
	...
	<div>
		<h2 style="left: 42%; top: 8%; position: absolute;">Welcome</h2><br><br><br><br><br><br><br>
		<center><h2> ${ farmerInFo.farmerFullName }</h2></center>
	</div>

	<br />
	<h1>${ errort }</h1>
	<br />
	<div style="left:35%;top: 38%; position: absolute;">
		<table>
			<tr>
				<th>Crop Type - ${cropbycropid.cropType }</th>
			</tr>
			<tr>
				<th>Crop Name - ${cropbycropid.cropName }</th>
			</tr>
			<tr>
				<th>Base Price - ${cropbycropid.cropBasicPrice }<%="\t\tRs" %></th>
			</tr>
		</table>
		<table>
			<tr>
				<th>Previous Bids for This Crop</th>
			</tr>
			<c:forEach items="${ bidDetailsbycropid }" var="bid">
				<tr>
					<td><%=i++ +")\t\t" %><c:out value="${bid.bidAmount}" /><%="\t\tRs" %></td>
				</tr>
			</c:forEach>
		</table>
	</div>
	<div style="left:53%; top: 53%; position: absolute;">
		<table style="float: left">
			<tr>
				<th>Current Bid</th>
			</tr>
			<tr>
				<td><%="1)\t\t" %>${ currentbidamount }<%="\t\tRs" %></td>
			</tr>
		</table>
	</div>
