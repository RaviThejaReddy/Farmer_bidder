...
<body class="bg">
	...
	<h2 style="left: 43%; top: 8%; position: absolute;">Welcome</h2>
	<br>
	<br><br><br>
	<br><br>
	<center>
		<h2>${loggedBidder.bidderFullName }</h2>
	</center>
	<div style="display: inline;">
		<div style="left: 8%; top: 35%; position: absolute;">
			<h1 style="margin-bottom: 0%">Your Active Bids</h1>
			<table>
				<tr>
					<th>Crop Type</th>
					<th>Crop Name</th>
				...
				<c:forEach items="${ activeBidDetails }" var="bd">
					<tr>
						...
						<td>${ bd.bidAmount }<%="\t\tRs"%></td>
					</tr>
				</c:forEach>
			</table>
		</div>
		<div style="left: 36%; top: 35%; position: absolute;">
			<h1 style="margin-bottom: 0%">Your Successful Bids</h1>
			<table>
				<tr>
					<th>Crop Type</th>
					<th>Crop Name</th>
		...
		<div style="left: 69%; top: 35%; position: absolute;">
			<h1 style="margin-bottom: 0%">Your Unsuccessful Bids</h1>
			<table>
				<tr>
					<th>Crop Type</th>
					<th>Crop Name</th>
	...
	<script>
		var auto = setInterval(function() {
			$('#sam').load('activebids.rsvp').fadeIn("slow");
		}, 5000);
