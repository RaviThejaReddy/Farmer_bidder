...
<button class="tablink" onclick="openFunction('AboutUs', this, 'transparent')" >AboutUs</button>
...
<h1 style="left:33%;right:15%;top:58%;position:absolute;">${ successs }</h1>
<h1 style="left:33%;right:15%;top:65%;position:absolute;">${ success }</h1>
<div>
<div>
...
<h1 style="left:37.5%;right:30%;top:47%;position:absolute;">${ logoutmsg }</h1>
</div>
