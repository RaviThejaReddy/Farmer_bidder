...
<body class="bg">
<div style="top:0;">
<button class="tablink" onclick="openFunction('HomePage', this, 'transparent')" >Home Page</button>
...
<div>
<div>
<h2  style="left:28%;top:15%;position:absolute;">Welcome To Biotic</h2>
<h1 style="left:35%;top:35%;position:absolute;">Fresh Organic Food</h1>
<h1 style="left:32%;top:47%;position:absolute;">${ logoutmsg }</h1>
</div>
