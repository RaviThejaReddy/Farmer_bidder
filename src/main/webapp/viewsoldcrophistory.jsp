...
<body class="bg">
	...
	<div>
		<h2 style="left: 43%; top: 13%; position: absolute;">Welcome</h2><br><br><br><br><br><br><br>
		<center><h2> ${ farmerInFo.farmerFullName }</h2></center>
		<h1 style="left: 40%;  top: 33%; position: absolute;">Your
			Sold Crops</h1>
	</div>
	<div>
	<br>
			...
			<tbody>
				<c:forEach items="${ ListOfCrops }" var="crop">
					<tr>
						...
						<td><c:out value="${crop.cropSoldPrice}" /><%="\t\tRs" %></td>
						<td><c:out value="${crop.cropSoldPrice*crop.cropQuantity}" /><%="\t\tRs" %></td>
