...
public class BidderRepository {
	...
	public void saveBidder(Bidder bidder,Login login,DetailsBidder detailsBidder) {
		...
		Bidder bidder1=(Bidder) entityManager.merge(bidder);
		bidder1.setDetailsBidder(detailsBidder);
		entityManager.merge(bidder1);
	}
	...
	public Login isEmailUnique(String email) {
